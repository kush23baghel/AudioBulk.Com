  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await generateAIResponse(
        input, "You are an expert Dialogue Generator. Output highly creative, professional results. Do not include conversational filler like 'Here is your...'. Just output the final result."
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="text-sm breadcrumbs text-slate-400">
        <ul>
          ...
          <li className="text-violet-400 font-medium">Dialogue Generator</li>
        </ul>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight font-sora">Dialogue Generator</h1>
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col space-y-2">
              ...
              <textarea
                ...
                placeholder="E.g., Provide details for dialogue generator..."
                rows={8}
